...
void InitialiseUAREA()
{
   ...
   for(i = 0; i < MAXOPENFILES; i++)
   {
    ...
    printf("My CVFS : UAREA gets initialised succesfully\n");
}
...
void InitialiseSuperBlock()
{
    ...
    printf("My CVFS : Super block gets initialised succesfully\n");
}
...
void CreateDILB()
{
    ...
    printf("My CVFS : DILB created succesfully\n");
}
...
void StartAuxillaryDataInitilisation()
{
    ...
    printf("My CVFS : Auxillary data initialised succesfully\n");
}
...
void LsFile()
{
    ...
    printf("-----------------------------------------------\n");
    printf("------ My CVFS Files Information ------\n");
    printf("-----------------------------------------------\n");
...
int main()
{
    ...
    printf("-----------------------------------------------\n");
    printf("----- My CVFS started succesfully -----\n");
    printf("-----------------------------------------------\n");
